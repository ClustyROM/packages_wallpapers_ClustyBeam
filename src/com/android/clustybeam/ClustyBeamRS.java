...
public class ClustyBeamRS {
    public static String LOG_TAG = "ClustyBeam";
    public static final int DOT_COUNT = 28;
    private Resources mRes;
    private RenderScriptGL mRS;
    private ScriptC_clustybeam mScript;
    int mHeight;
    int mWidth;
    ...
    public void init(int dpi, RenderScriptGL rs, Resources res, int width, int height) {
        if (!mInited) {
            ...
            mScript = new ScriptC_clustybeam(mRS, mRes, R.raw.clustybeam);
